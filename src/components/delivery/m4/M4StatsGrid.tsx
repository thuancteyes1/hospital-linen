...
import { Building2, Truck, Clock, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-gradient-to-br from-red-50 to-rose-100/30 border border-red-200 rounded-2xl p-4 shadow-2xs flex items-center gap-4">
        <div className="w-10 h-10 bg-red-100 text-red-700 rounded-xl flex items-center justify-center shrink-0 animate-pulse">
