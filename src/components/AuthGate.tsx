          ...
          <div className="p-6 flex-1 fade-in">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center my-4">
                ...
                <span className="px-3 text-[10px] text-slate-400 font-bold uppercase tracking-wider">Hoặc</span>
                <div className="flex-1 border-t border-black/5"></div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 text-xs font-semibold flex items-center justify-center gap-2.5 rounded-xl transition-all shadow-sm"
              >
                ...
                {isSigningInGoogle ? 'Đang kết nối...' : 'Đăng nhập bằng Google'}
              </button>
            </div>
